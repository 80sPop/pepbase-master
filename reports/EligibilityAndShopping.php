...
// htmlspecialchars() to decode accent characters stored in arrays.		-mlr	
			echo "
			Por favor, utilice los cuadros y líneas en la izquierda, y </i>NO LOS RECTANGULOS GRIS.</i>
			Para los productos con líneas,<i>POR FAVOR ESCRIBA EL NUMERO QUE NECESITA</i>, hasta el límite indicado.";		
		else
